...
| **Nguyễn Đình Liêm** | Học viên ngoài nhóm | Gõ câu hỏi sai chính tả "tóm tat slde day 2" | Intent classifier đoán sai thành OUT_OF_DOMAIN vì regex quá cứng nhắc với từ "slde" (typo của slide). | *"Sao gõ tóm tắt slide mà bot lại bảo không hỗ trợ nội dung này nhỉ?"* | **High** 🚨 |
| **Trần Hoàng Vũ** | Học viên ngoài nhóm | Thử bẫy hỏi "Món ăn yêu thích của bot là gì?" | Bot từ chối trả lời lịch sự và tự động liệt kê các tác vụ nó có thể hỗ trợ (ops, quiz, outline). Lối thoát Graceful Failure tốt. | *"Bot biết từ chối và hướng dẫn mình hỏi đúng trọng tâm học tập."* | **Low** info |
...
4. **Khắc phục lỗi đoán sai intent của Nguyễn Đình Liêm**:
